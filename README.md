...
```
cd existing_repo
git remote add origin https://gitlab.com/ufc-dc/compilers-minijava-2023/team-8.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ufc-dc/compilers-minijava-2023/team-8/-/settings/integrations)
